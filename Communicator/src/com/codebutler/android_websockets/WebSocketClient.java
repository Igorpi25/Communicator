...
public class WebSocketClient {
 ...
 //------------------------ivanov.tech.chat Extension---------------------
    
    public void sendWithOutgoingProtocol(int outgoing_failed_type, int message_id, String message,final OutgoingListener outgoinglistener) {
    	sendFrameWithOutgoingProtocol(outgoing_failed_type,message_id,message,outgoinglistener);
    }

    void sendFrameWithOutgoingProtocol(final int outgoing_failed_type, final int message_id, final String message, final OutgoingListener outgoinglistener) {
    	
    	final byte[] frame=mParser.frame(message.toString());
